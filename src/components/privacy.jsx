    ...
    <React.Fragment>
      ...
      <div className="privacy-policy">
        ...
        <p>
          ...
          information. Please review this policy carefully to understand our
        ...
        <p>
          When you visit our website and voluntarily provide us with personal
          details, such as your name, email address, phone number, and other
          contact information, we collect and store this data. Additionally, we
          may gather any other information you choose to provide, including
          preferences, budget, and other relevant details.
        </p>

        <h4>1.2 Usage Information</h4>
        <p>
          We may automatically collect non-personal information when you use our
          website, including your IP address, browser type, operating system,
          and the pages you visit. This information helps us improve our website
        ...
        <p>
          ...
          browsing experience, analyze traffic, and improve website
          functionality. You can disable cookies through your browser settings,
          but some features of the website may not work properly as a result.
        </p>
        ...
        <p>
          We use your personal information to deliver the services you request,
          such as contacting you with property listings, responding to
          inquiries, and facilitating communication between you and potential
          buyers or sellers.
        </p>

        <h4>2.2 Website Improvement</h4>
        <p>
        ...
        <h4>2.3 Marketing Communications</h4>
        <p>
          With your consent, we may send you marketing communications about our
          services, special offers, or other relevant information via email,
          SMS/text messages, or other communication channels. You can opt out of
        ...
        <p>
          We may use or disclose your personal information if required to do so
          by law, regulation, legal process, or government request, or to
        ...
        <p>
          We do not share your personal information with third-party providers.
        </p>

        <h4>3.2 Privacy Choices</h4>
        <p>
          We respect your privacy preferences and will not share your personal
          information with third parties for marketing or promotional purposes
          without your consent.
        </p>

        <h4>3.3 Legal Obligations</h4>
        <p>
        ...
        <p>
          ...
          without appropriate parental consent, we will take steps to delete it.
        </p>
        ...
        <p>
          ...
          changes by posting the updated policy on our website and indicating
          the effective date.
        </p>
